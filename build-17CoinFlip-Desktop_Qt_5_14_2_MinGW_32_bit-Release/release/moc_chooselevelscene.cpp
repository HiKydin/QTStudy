...
#include <memory>
#include "../../17CoinFlip/chooselevelscene.h"
...
QT_MOC_LITERAL(1, 17, 7), // "IamBack"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "ChooseLevelScene\0IamBack\0"
};
...
void ChooseLevelScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChooseLevelScene::IamBack)) {
                *result = 0;
                return;
            }
        }
