...
#include <memory>
#include "../../17CoinFlip/playscene.h"
...
QT_MOC_LITERAL(1, 10, 7), // "IamBack"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "PlayScene\0IamBack\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::IamBack)) {
                *result = 0;
                return;
            }
        }
